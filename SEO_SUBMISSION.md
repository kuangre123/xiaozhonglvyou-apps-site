...
- Previous product evidence pass: Anti-spy screen was refreshed to version 1.5.1 and Anti-spy screen Lite remained version 1.4.1; English and Simplified Chinese Mac privacy facts were rechecked against Apple's public records on 2026-08-03.
- 2026-09-23 US App Store recheck: Anti-spy screen (`6761301764`) is version 1.5.3 at USD 3.99; Anti-spy screen Lite (`6766485393`) is version 1.4.5 and free. Both listings require macOS 13.0 or later. Published copy and SoftwareApplication offers were refreshed; prices can vary by storefront and may change. Source: `https://itunes.apple.com/lookup?id=6761301764,6766485393&country=us`.
- Latest app portfolio pass: GIFmaker 1.1.4 and HappyRide 1.4.1 have English and Simplified Chinese product pages, App Store IDs, official icons, verified compatibility, SoftwareApplication entities, FAQs, hreflang pairs, Smart App Banners, support/privacy anchors, and sitemap/search discovery.
- 2026-09-23 US App Store portfolio recheck: AI Cleaning 1.1.6, Translation Specialist 2.2.3, GIFmaker 1.1.4, HappyRide 1.4.1, Lailemma 2.0.5, Inkstone 1.0.0, and TwoPic 1.1.3 at USD 0.99. Lailemma 2.0.5 release notes confirm Body Readiness is public; Japan and Germany storefronts also return 2.0.5, while the China storefront did not return this app in the lookup API. Source: `https://itunes.apple.com/lookup?id=6768019606,6755734543,6783559364,6786365305,6775935474,6810287923,6800405096&country=us`.
- Before future publication, run `node scripts/audit-live-app-store-facts.mjs` from this repository. It compares the nine homepage SoftwareApplication versions and US upfront prices against Apple's live lookup API; it is separate from the offline site release gate because network or API failures do not prove factual drift.
