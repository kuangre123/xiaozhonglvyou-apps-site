...
- Latest local search-intent pass: 2026-09-04; the Japanese, German, and Turkish photo-cleaner decision pages now include visible local search verification guidance for Google, Yahoo! JAPAN, Bing, Ecosia, DuckDuckGo, and Yandex as appropriate, plus a comparison-page path before the local App Store click. This improves site-side discovery and decision flow; it does not claim confirmed indexing, impressions, or clicks without webmaster or analytics data.
