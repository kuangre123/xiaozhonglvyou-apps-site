...
const brazil = {
  ...
  skip: "Ir para o conteúdo", nav: ["Apps", "Guias", "Países"], eyebrow: "App Store do Brasil", h1: "Apps para iPhone e Mac.",
  ...
  primary: "Abrir o AI Cleaning", secondary: "Ver os seis apps", checked: "Informações da App Store verificadas",
...
const mexico = {
  ...
  skip: "Ir al contenido", nav: ["Apps", "Guías", "Países"], eyebrow: "App Store de México", h1: "Apps para iPhone y Mac.",
  ...
  primary: "Abrir AI Cleaning", secondary: "Ver las seis apps", checked: "Información de la App Store comprobada",
